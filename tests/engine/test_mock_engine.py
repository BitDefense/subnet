...
def test_mock_engine_returns_ones():
    ...
    payload = TransactionPayload(
        ...
        hash="0x0", blockHash="0x0", block_number="0x0",
    ...
    challenge = Challenge(chain_id="1", block_number="0", tx=tx, invariants=[inv1, inv2])
...
def test_mock_engine_empty_invariants():
    ...
    tx = Transaction(hash="0x0", payload=payload)
    challenge = Challenge(chain_id="1", block_number="0", tx=tx, invariants=[])
